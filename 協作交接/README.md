...
- [給 Claude｜AI 咒語師專案｜v0.3 前全案一致性盤點請求](./給Claude｜AI咒語師專案｜v0.3前全案一致性盤點請求.md)（**請先做這份**）
- [AI 咒語師專案｜跨文件對照資料包](./AI咒語師專案｜跨文件對照資料包v0.1.md)（Claude 盤點依據）
- [給 Claude｜AI 咒語師護照｜v0.3 複審請求](./給Claude｜AI咒語師護照｜v0.3複審請求.md)（全案盤點後再複審）
